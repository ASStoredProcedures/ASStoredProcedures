...
"C:\Program Files (x86)\MSBuild\14.0\Bin\msbuild.exe" build.msproj /p:Configuration="%config%" /p:Platform="x64" /m /v:M /fl /flp:LogFile=msbuild2017.log;Verbosity=Normal /nr:false /target:ZipFile /p:Edition="2017"
pause